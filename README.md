# Machine Learning Deployment using AWS SageMaker Notebooks

This repository contains code and associated files for deploying ML models using AWS SageMaker Notebooks. This repository consists of a number of tutorial notebooks for various coding exercises, mini-projects, and project files that will be used to supplement the lessons of the [Udacity Deep Learning Nanodegree](https://www.udacity.com/course/deep-learning-nanodegree--nd101).

My notes and code related to that MOOC can be found in the following repository: [deep_learning_udacity](https://github.com/mxagar/deep_learning_udacity). In particular, the guide on AWS SageMaker is contained in the file [`DLND_Deployment.md`](https://github.com/mxagar/deep_learning_udacity/blob/main/06_Deployment/DLND_Deployment.md) from that repository.

Additionally, I add here the file [`sagemaker_examples.py`](./sagemaker_examples.py), which is a summary of the tutorials and mini-projects contained in the present repository. The following diagram shows how the different code blocks in the the summary script are related to each other:

![SageMaker Examples Workflow](./sagemaker_examples_workflow.png)

## Table Of Contents

- [Machine Learning Deployment using AWS SageMaker Notebooks](#machine-learning-deployment-using-aws-sagemaker-notebooks)
  ...
  - [Setup Instructions](#setup-instructions)
    ...
    - [Open and run the notebook of your choice](#open-and-run-the-notebook-of-your-choice)
...
My implemented version of the project can be found in another repository: [sentiment_rnn_aws_deployment](https://github.com/mxagar/sentiment_rnn_aws_deployment).
...
```bash
cd SageMaker
git clone https://github.com/mxagar/sagemaker-deployment.git
exit
```

After you have finished, close the terminal window.

:warning: AWS SageMaker now allows to add Github repositories when the notebook instance is created; it is suggested to use that functionality.
